...
public class EnemyBat1Attack : MonoBehaviour
{
   ...
   private Coroutine shootCirclesCoroutine;
        ...
        while (isShooting) {
            ...
            yield return new WaitForSeconds(shootInterval);
                ...
                if (circleCount.Count < 3) {
                    GameObject bat = GameObject.FindGameObjectWithTag("Bat1");
    ...
    IEnumerator fireProjectile(Transform projectile, Vector2 targetPosition, float speed) {
        ...
        while (projectile != null) {
            ...
            if (Vector2.Distance(projectile.position, targetPosition) < 0.01f) {
